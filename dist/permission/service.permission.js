...
exports.ServicePermission = void 0;
...
class ServicePermission extends base_permission_1.BasePermission {
    constructor(req) {
        super(req, default_role_name_data_1.ROLE_NAME.serviceManager, new service_model_1.Service());
    }
    toStore() {
...
exports.ServicePermission = ServicePermission;
